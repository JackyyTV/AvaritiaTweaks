...
@Mod(modid = Reference.MODID, version = Reference.VERSION, name = Reference.MODNAME, dependencies = Reference.DEPENDS, acceptedMinecraftVersions = Reference.MCVERSION, guiFactory = Reference.GUIFACTORY, certificateFingerprint = "@FINGERPRINT@", useMetadata = true)
